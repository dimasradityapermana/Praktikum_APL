...
void tambahMerk(merk listMerk[], int &jumlahMerk) 
{
    ...
    if (jumlahMerk < batasMerk) {
        if (!cekMerk(listMerk, jumlahMerk, namaMerk)) {
            ...
            listMerk[jumlahMerk].stok.jumlah = 1;
            jumlahMerk++;
...
void tampilkanMerk(merk listMerk[], int &jumlahMerk) 
{
    if (jumlahMerk == 0) {
        ...
        for (int i = 0; i < jumlahMerk; ++i) {
            cout << listMerk[i].namaMerk << " (Stok: " << listMerk[i].stok.jumlah << ")" << endl;
        }
    }
...
void tambahStok(merk listMerk[], int &jumlahMerk)  
{
    ...
    if (indeks != -1) {
        ...
        cin >> tambahanStok;
        if (tambahanStok > 0) {
            listMerk[indeks].stok.jumlah += tambahanStok;
            cout << "Stok berhasil ditambahkan untuk merk " << namaMerk << ". Stok sekarang: " << listMerk[indeks].stok.jumlah << endl;
        } else {
...
void kurangiStok(merk listMerk[], int &jumlahMerk) 
{
    ...
    if (indeks != -1) {
        ...
        cin >> kurangiStok;
        if (kurangiStok > 0 && kurangiStok <= listMerk[indeks].stok.jumlah) {
            listMerk[indeks].stok.jumlah -= kurangiStok;
            cout << "Stok berhasil dikurangi untuk merk " << namaMerk << ". Stok sekarang: " << listMerk[indeks].stok.jumlah << endl;
        } else if (kurangiStok > listMerk[indeks].stok.jumlah) {
